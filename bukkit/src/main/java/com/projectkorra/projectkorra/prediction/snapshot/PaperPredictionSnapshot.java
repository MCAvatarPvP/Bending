 ...
 */
public final class PaperPredictionSnapshot {
    ...
    public static List<PaperPredictionProtocol.ConfigEntry> config() {
    ...
    public static List<PaperPredictionProtocol.AbilityProfile> profiles() {
