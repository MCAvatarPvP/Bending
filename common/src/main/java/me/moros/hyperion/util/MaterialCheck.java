...
import com.projectkorra.projectkorra.platform.mc.block.CreatureSpawner;
...
public class MaterialCheck {
    ...
    public static boolean isUnbreakable(Block block) {
        return UNBREAKABLES.contains(block.getType()) || (block.getState() instanceof InventoryHolder) ||
                ...
                ConfigManager.getConfig().getStringList("ExtraUnbreakableMaterials").contains(block.getType().name());
    }
