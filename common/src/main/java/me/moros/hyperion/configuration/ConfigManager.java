...
public class ConfigManager {
    ...
    public static Config getConfig(BendingPlayer bPlayer) {
    ...
    public void setupModifiersConfig() {
        Config config = modifiersConfig.getConfig();
    ...
    public void setupMainConfig() {
        ...
        config.addDefault("Abilities.Earth.EarthShot.Iframes", true);
        ...
        config.addDefault("Abilities.Earth.EarthGlove.Speed", 1.2);
        config.addDefault("Abilities.Earth.EarthGlove.GrabSpeed", 0.6);
        ...
        config.addDefault("Abilities.Earth.EarthGlove.ClingPassive.Slide", true);
        config.addDefault("Abilities.Earth.EarthGlove.ClingPassive.SlideSpeed", 0.3);
        config.addDefault("Abilities.Earth.EarthGlove.ClingPassive.Cooldown", 0);
        ...
        config.addDefault("Abilities.Earth.MetalCable.Speed", 1.8);
        config.addDefault("Abilities.Earth.MetalCable.CollisionRadius", 0.6);
        ...
        config.addDefault("Abilities.Fire.Combustion.SuicideCooldown", 10000);
        config.addDefault("Abilities.Fire.Combustion.DamageCooldown", 10000);
        ...
        config.addDefault("Abilities.Fire.Combustion.FireRadius", 3.0);
        config.addDefault("Abilities.Fire.Combustion.MisfireModifier", -1.0);
        config.addDefault("Abilities.Fire.Combustion.DamageCheck", 0.5);
        ...
        config.addDefault("Abilities.Fire.Combustion.CanSwapSlots", true);
        config.addDefault("Abilities.Fire.Combustion.AllowWhenFireShield", false);
        config.addDefault("Abilities.Fire.Combustion.ExplodeOnClick", false);
        ...
        config.addDefault("Abilities.Fire.FireCombo.FireWave.Radius", 1);
        ...
        config.addDefault("Abilities.Fire.FireCombo.FireWave.FireTicks", 30);
        config.addDefault("Abilities.Fire.FireCombo.FireWave.StopWhenOtherSlot", false);
        config.addDefault("Abilities.Fire.FireCombo.FireWave.Combination", Arrays.asList("HeatControl:SHIFT_DOWN", "HeatControl:SHIFT_UP", "HeatControl:SNEAK_DOWN", "HeatControl:SHIFT_UP", "WallOfFire:SHIFT_DOWN"));
        config.addDefault("Abilities.Fire.FireCombo.FireWave.Instructions", "HeatControl (Tap Sneak) > HeatControl (Tap Sneak) > WallOfFire (Hold Sneak)");
