...
import com.projectkorra.projectkorra.platform.mc.block.Lockable;
...
public class Locksmithing extends MetalAbility implements AddonAbility, PassiveAbility {
    ...
    public boolean isEnabled() {
        return ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.LockSmithing.Enabled");
    }
    ...
    public String getDescription() {
        return ConfigManager.getConfig(bPlayer).getString("Abilities.Earth.LockSmithing.Description");
    }

    @Override
    public String getInstructions() {
        return ConfigManager.getConfig(bPlayer).getString("Abilities.Earth.LockSmithing.Instructions");
    }
    ...
    public long getCooldown() {
        return ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.LockSmithing.Cooldown");
    }
