...
public class EarthGuard extends EarthAbility implements AddonAbility {
    ...
    public EarthGuard(Player player) {
        ...
        cooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.EarthGuard.Cooldown");
        duration = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.EarthGuard.Duration");
        selectRange = ConfigManager.getConfig(bPlayer).getInt("Abilities.Earth.EarthGuard.SelectRange");
        ...
        if (isEarthbendable(sourceBlock)) {
            ...
            if (isMetal(sourceBlock)) {
                ...
                resistance = ConfigManager.getConfig(bPlayer).getInt("Abilities.Earth.EarthGuard.MetalResistance") - 1;
    ...
    public boolean isEnabled() {
        return ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.EarthGuard.Enabled");
    }
    ...
    public String getDescription() {
        return ConfigManager.getConfig(bPlayer).getString("Abilities.Earth.EarthGuard.Description");
    }
