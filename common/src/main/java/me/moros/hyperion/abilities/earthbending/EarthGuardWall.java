...
public class EarthGuardWall extends EarthAbility implements AddonAbility {
    ...
    public EarthGuardWall(Player player) {
        ...
        wallDuration = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.EarthGuard.WallDuration");
        wallCooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.EarthGuard.WallCooldown");
