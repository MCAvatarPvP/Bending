...
public class Bolt extends LightningAbility implements AddonAbility {
    ...
    public Bolt(final Player player) {
        ...
        damage = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Fire.Bolt.Damage");
        cooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Fire.Bolt.Cooldown");
        range = ConfigManager.getConfig(bPlayer).getInt("Abilities.Fire.Bolt.Range");
        chargeTime = ConfigManager.getConfig(bPlayer).getLong("Abilities.Fire.Bolt.ChargeTime");
    ...
    public boolean isEnabled() {
        return ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Fire.Bolt.Enabled");
    }
    ...
    public String getDescription() {
        return ConfigManager.getConfig(bPlayer).getString("Abilities.Fire.Bolt.Description");
    }
    ...
    private void strike() {
        ...
        player.getWorld().strikeLightningEffect(location, true);
