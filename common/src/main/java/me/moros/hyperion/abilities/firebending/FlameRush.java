...
public class FlameRush extends FireAbility implements AddonAbility {
    ...
    private void setFields() {
        this.cooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Fire.FlameRush.Cooldown");
        this.damage = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Fire.FlameRush.Damage");
        this.speed = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Fire.FlameRush.Speed");
        this.range = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Fire.FlameRush.Range");
        this.chargeFactor = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Fire.FlameRush.ChargeFactor");
        this.maxChargeTime = ConfigManager.getConfig(bPlayer).getLong("Abilities.Fire.FlameRush.MaxChargeTime");
        this.startingCollisionRadius = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Fire.FlameRush.CollisionRadius");
        this.knockback = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Fire.FlameRush.Knockback");
        this.fireTicks = ConfigManager.getConfig(bPlayer).getInt("Abilities.Fire.FlameRush.FireTicks");
    }
    ...
    public boolean isEnabled() {
        return ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Fire.FlameRush.Enabled");
    }
    ...
    public String getDescription() {
        return ConfigManager.getConfig(bPlayer).getString("Abilities.Fire.FlameRush.Description");
    }
