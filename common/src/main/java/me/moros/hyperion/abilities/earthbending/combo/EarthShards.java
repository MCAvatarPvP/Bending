...
public class EarthShards extends EarthAbility implements AddonAbility, ComboAbility {
    ...
    public EarthShards(Player player) {
        ...
        cooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.EarthCombo.EarthShards.Cooldown");
        shotCooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.EarthCombo.EarthShards.ShotCooldown");
        int maxShards = ConfigManager.getConfig(bPlayer).getInt("Abilities.Earth.EarthCombo.EarthShards.MaxShards");
    ...
    public boolean isEnabled() {
        return ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.EarthCombo.EarthShards.Enabled");
    }
    ...
    public String getDescription() {
        return ConfigManager.getConfig(bPlayer).getString("Abilities.Earth.EarthCombo.EarthShards.Description");
    }
