...
public class EarthShot extends EarthAbility implements AddonAbility {
    ...
    public EarthShot(Player player) {
        ...
        damage = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Earth.EarthShot.Damage");
        cooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.EarthShot.Cooldown");
        range = ConfigManager.getConfig(bPlayer).getInt("Abilities.Earth.EarthShot.Range");
        selectRange = ConfigManager.getConfig(bPlayer).getInt("Abilities.Earth.EarthShot.SelectRange");
        iframes = ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.EarthShot.Iframes");
        allowQuickLaunch = ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.EarthShot.AllowQuickLaunch");
        magmaShot = ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.EarthShot.MagmaShot.AllowConvert");
        magmaModifier = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Earth.EarthShot.MagmaShot.DamageModifier");
        chargeTime = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.EarthShot.MagmaShot.ChargeTime");
    ...
    public void progress() {
        if (launched) {
            ...
            this.location = projectile.getFallingBlock().getLocation();
            checkBlast(false);
        } else {
    ...
    public boolean isEnabled() {
        return ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.EarthShot.Enabled");
    }
    ...
    public String getDescription() {
        return ConfigManager.getConfig(bPlayer).getString("Abilities.Earth.EarthShot.Description");
    }
