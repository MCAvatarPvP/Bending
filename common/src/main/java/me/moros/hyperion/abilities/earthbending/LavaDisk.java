...
public class LavaDisk extends LavaAbility implements AddonAbility, MultiAbility {
    ...
    public LavaDisk(Player player) {
        ...
        maxDamage = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Earth.LavaDisk.MaxDamage");
        minDamage = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Earth.LavaDisk.MinDamage");
        cooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.LavaDisk.Cooldown");
        range = ConfigManager.getConfig(bPlayer).getInt("Abilities.Earth.LavaDisk.Range");
        regenDelay = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.LavaDisk.RegenDelay");
        passHit = ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.LavaDisk.PassThroughEntities");
        materials = new HashSet<>(ConfigManager.getConfig(bPlayer).getStringList("Abilities.Earth.LavaDisk.AdditionalMeltableBlocks"));
    ...
    public boolean isEnabled() {
        return ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.LavaDisk.Enabled");
    }
    ...
    public String getDescription() {
        return ConfigManager.getConfig(bPlayer).getString("Abilities.Earth.LavaDisk.Description");
    }
