...
public class EarthLine extends EarthAbility implements AddonAbility {
    ...
    public EarthLine(Player player) {
        ...
        damage = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Earth.EarthLine.Damage");
        cooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.EarthLine.Cooldown");
        range = ConfigManager.getConfig(bPlayer).getInt("Abilities.Earth.EarthLine.Range");
        selectRange = ConfigManager.getConfig(bPlayer).getInt("Abilities.Earth.EarthLine.SelectRange");
        makeSpikes = ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.EarthLine.MakeSpikes");
        earthLineSpeed = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Earth.EarthLine.Speed");
        allowUnderWater = ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.EarthLine.AllowUnderWater");
        magmaModifier = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Earth.EarthLine.Magma.DamageModifier");
        magmaLineSpeed = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Earth.EarthLine.Magma.Speed");
        breakBlocks = ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.EarthLine.Magma.BreakBlocks");
        regen = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.EarthLine.Magma.RegenDelay");
        prisonCooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.EarthLine.PrisonCooldown");
        prisonDuration = ConfigManager.getConfig(bPlayer).getLong("Abilities.Earth.EarthLine.PrisonDuration");
        prisonRadius = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Earth.EarthLine.PrisonRadius");
        prisonPoints = ConfigManager.getConfig(bPlayer).getInt("Abilities.Earth.EarthLine.PrisonPoints");
    ...
    private void imprisonTarget() {
        if (!GeneralMethods.isOnGround(target)) {
    ...
    public boolean isEnabled() {
        return ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Earth.EarthLine.Enabled");
    }
    ...
    public String getDescription() {
        return ConfigManager.getConfig(bPlayer).getString("Abilities.Earth.EarthLine.Description");
    }
