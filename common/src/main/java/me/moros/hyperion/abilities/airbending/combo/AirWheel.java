...
public class AirWheel extends AirAbility implements AddonAbility, ComboAbility {
    ...
    public AirWheel(Player player) {
        ...
        damage = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Air.AirCombo.AirWheel.Damage");
        knockback = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Air.AirCombo.AirWheel.Knockback");
        cooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Air.AirCombo.AirWheel.Cooldown");
        affectCooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Air.AirCombo.AirWheel.AffectCooldown");
    ...
    public boolean isEnabled() {
        return ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Air.AirCombo.AirWheel.Enabled");
    }
    ...
    public String getDescription() {
        return ConfigManager.getConfig(bPlayer).getString("Abilities.Air.AirCombo.AirWheel.Description");
    }
