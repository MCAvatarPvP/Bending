...
public class IceDrill extends IceAbility implements AddonAbility, ComboAbility {
    ...
    public IceDrill(Player player) {
        ...
        cooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Water.WaterCombo.IceDrill.Cooldown");
        selectRange = ConfigManager.getConfig(bPlayer).getInt("Abilities.Water.WaterCombo.IceDrill.SelectRange");
        maxLength = ConfigManager.getConfig(bPlayer).getInt("Abilities.Water.WaterCombo.IceDrill.MaxLength");
        duration = ConfigManager.getConfig(bPlayer).getLong("Abilities.Water.WaterCombo.IceDrill.Duration");
        regenDelay = ConfigManager.getConfig(bPlayer).getLong("Abilities.Water.WaterCombo.IceDrill.RegenDelay");
    ...
    public boolean isEnabled() {
        return ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Water.WaterCombo.IceDrill.Enabled");
    }
    ...
    public String getDescription() {
        return ConfigManager.getConfig(bPlayer).getString("Abilities.Water.WaterCombo.IceDrill.Description");
    }
