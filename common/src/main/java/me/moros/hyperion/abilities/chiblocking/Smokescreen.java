...
public class Smokescreen extends ChiAbility implements AddonAbility {
    ...
    public Smokescreen(Player player) {
        ...
        cooldown = ConfigManager.getConfig(bPlayer).getLong("Abilities.Chi.Smokescreen.Cooldown");
        cloudTicks = NumberConversions.ceil(ConfigManager.getConfig(bPlayer).getLong("Abilities.Chi.Smokescreen.CloudDuration") / 50.0);
        blindnessTicks = ConfigManager.getConfig(bPlayer).getInt("Abilities.Chi.Smokescreen.BlindnessTicks");
        radius = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Chi.Smokescreen.Radius");
    ...
    public boolean isEnabled() {
        return ConfigManager.getConfig(bPlayer).getBoolean("Abilities.Chi.Smokescreen.Enabled");
    }
    ...
    public String getDescription() {
        return ConfigManager.getConfig(bPlayer).getString("Abilities.Chi.Smokescreen.Description");
    }
