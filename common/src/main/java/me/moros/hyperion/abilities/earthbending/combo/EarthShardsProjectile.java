...
public class EarthShardsProjectile extends EarthAbility implements AddonAbility {
    ...
    public EarthShardsProjectile(Player player, Location spawnLocation) {
        ...
        damage = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Earth.EarthCombo.EarthShards.Damage");
        range = ConfigManager.getConfig(bPlayer).getInt("Abilities.Earth.EarthCombo.EarthShards.Range");
        double accuracyDrop = ConfigManager.getConfig(bPlayer).getDouble("Abilities.Earth.EarthCombo.EarthShards.AccuracyDrop");
