...
public class ChiblockJab extends ChiAbility implements ComboAbility, AddonAbility {
    ...
    public ChiblockJab(Player player) {
        ...
        duration = ProjectAddons.instance.getConfig(bPlayer).getLong("Combos.Chi.ChiblockJab.Duration");
        cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Combos.Chi.ChiblockJab.Cooldown");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Combos.Chi.ChiblockJab.Enabled");
    }
}
