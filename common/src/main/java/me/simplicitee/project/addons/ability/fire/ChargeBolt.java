...
public class ChargeBolt extends LightningAbility implements AddonAbility {
    ...
    public ChargeBolt(Player player) {
        ...
        chargeTime = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.ChargeBolt.ChargeTime");
        damage = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.ChargeBolt.Damage");
        boltRange = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.ChargeBolt.BoltRange");
        blastRadius = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.ChargeBolt.BlastRadius");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Fire.ChargeBolt.Enabled");
    }
