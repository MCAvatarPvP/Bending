...
public class FlameBreath extends FireAbility implements AddonAbility, ComboAbility, Listener {
    ...
    private void setFields() {
        fireTick = ProjectAddons.instance.getConfig(bPlayer).getInt("Combos.Fire.FlameBreath.FireTick");
        range = ProjectAddons.instance.getConfig(bPlayer).getDouble("Combos.Fire.FlameBreath.Range");
        damage = ProjectAddons.instance.getConfig(bPlayer).getDouble("Combos.Fire.FlameBreath.Damage");
        burnGround = ProjectAddons.instance.getConfig(bPlayer).getBoolean("Combos.Fire.FlameBreath.Burn.Ground");
        burnEntities = ProjectAddons.instance.getConfig(bPlayer).getBoolean("Combos.Fire.FlameBreath.Burn.Entities");
        rainbow = ProjectAddons.instance.getConfig(bPlayer).getBoolean("Combos.Fire.FlameBreath.Rainbow");
        duration = ProjectAddons.instance.getConfig(bPlayer).getLong("Combos.Fire.FlameBreath.Duration");
        speed = ProjectAddons.instance.getConfig(bPlayer).getDouble("Combos.Fire.FlameBreath.Speed");
    ...
    public long getCooldown() {
        return ProjectAddons.instance.getConfig(bPlayer).getLong("Combos.Fire.FlameBreath.Cooldown");
    }
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Combos.Fire.FlameBreath.Enabled");
    }
