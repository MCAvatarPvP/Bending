...
public class QuickWeld extends MetalAbility implements AddonAbility {
    ...
    public QuickWeld(Player player, ItemStack item) {
        ...
        this.item = item;
        this.cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Earth.QuickWeld.Cooldown");
        this.repairAmount = ProjectAddons.instance.getConfig(bPlayer).getInt("Abilities.Earth.QuickWeld.RepairAmount");
        this.repairCooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Earth.QuickWeld.RepairInterval");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Earth.QuickWeld.Enabled");
    }
}
