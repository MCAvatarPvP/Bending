...
public class FireDisc extends FireAbility implements AddonAbility {
    ...
    public FireDisc(Player player) {
        ...
        this.damage = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.FireDisc.Damage");
        this.range = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.FireDisc.Range");
        this.control = ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Fire.FireDisc.Controllable");
        this.revert = ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Fire.FireDisc.RevertCutBlocks");
        this.drop = ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Fire.FireDisc.DropCutBlocks");
        this.cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.FireDisc.Cooldown");
        this.knockback = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.FireDisc.Knockback");
    ...
    public boolean cutBlock(Block b) {
        return ProjectAddons.instance.getConfig(bPlayer).getStringList("Abilities.Fire.FireDisc.CuttableBlocks").contains(b.getType().toString());
    }
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Fire.FireDisc.Enabled");
    }
