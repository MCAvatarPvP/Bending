...
public class RazorLeaf extends PlantAbility implements AddonAbility {
    ...
    public RazorLeaf(Player player, boolean sourced) {
        ...
        if (sourced) {
            Block source = player.getTargetBlockExact(7);
        ...
        this.cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Water.RazorLeaf.Cooldown");
        this.damage = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Water.RazorLeaf.Damage");
        this.radius = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Water.RazorLeaf.Radius");
        this.range = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Water.RazorLeaf.Range");
        this.particles = ProjectAddons.instance.getConfig(bPlayer).getInt("Abilities.Water.RazorLeaf.Particles");
        this.maxUses = ProjectAddons.instance.getConfig(bPlayer).getInt("Abilities.Water.RazorLeaf.MaxRecalls");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Water.RazorLeaf.Enabled");
    }
}
