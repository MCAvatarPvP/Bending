...
public class ProjectAddons implements JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.config = new Config(new File("ProjectAddons/project_addons.yml"));
        this.setupConfig();
    ...
    public PKConfiguration getConfig(BendingPlayer bPlayer) {
        return config.get(bPlayer);
    }
    ...
    private void setupConfig() {
        ...
        c.addDefault("Abilities.Earth.Accretion.MaxAmplifier", 3);
        ...
        c.addDefault("Abilities.Earth.Bulwark.Range", 1.5);
        c.addDefault("Abilities.Earth.Bulwark.AllowJumping", true);
        ...
        c.addDefault("Abilities.Earth.DigCombo.Cooldown", 3000);
        c.addDefault("Abilities.Earth.DigCombo.Duration", -1);
        c.addDefault("Abilities.Earth.DigCombo.RevertTime", 3500);
        c.addDefault("Abilities.Earth.DigCombo.Speed", 0.51);
        c.addDefault("Abilities.Earth.DigCombo.Radius", 3);
        c.addDefault("Abilities.Earth.DigCombo.Combination", Arrays.asList("EarthBlast:LEFT_CLICK", "EarthBlast:LEFT_CLICK", "Collapse:SHIFT_DOWN"));
        ...
        c.addDefault("Abilities.Earth.EarthKick.Range", 1);
        c.addDefault("Abilities.Earth.EarthKick.Iframes", true);
        ...
        c.addDefault("Abilities.Earth.LavaSurge.MagmaRadius", 0.7);
        c.addDefault("Abilities.Earth.LavaSurge.MagmaDuration", 0);
        c.addDefault("Abilities.Earth.LavaSurge.Duration", 4000);
        c.addDefault("Abilities.Earth.LavaSurge.ShootDelay", 0);
        c.addDefault("Abilities.Earth.LavaSurge.NormalBehavior", false);
        ...
        c.addDefault("Abilities.Earth.Shrapnel.Blast.Damage", 0.5);
		...
		*/
        ...
        c.addDefault("Abilities.Water.PlantArmor.FallDamage", true);
        ...
        c.addDefault("Combos.Chi.FlyingKick.CanActivateInWater", false);
    ...
    private void setupCollisions() {
        if (ProjectKorra.getCollisionInitializer() == null || ProjectKorra.getCollisionManager() == null) {
            return;
        }
