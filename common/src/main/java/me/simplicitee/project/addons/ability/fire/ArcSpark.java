...
public class ArcSpark extends LightningAbility implements AddonAbility {
    ...
    public ArcSpark(Player player) {
        ...
        this.damage = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.ArcSpark.Damage");
        this.cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.ArcSpark.Cooldown");
        this.duration = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.ArcSpark.Duration");
        this.charge = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.ArcSpark.ChargeTime");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Fire.ArcSpark.Enabled");
    }
