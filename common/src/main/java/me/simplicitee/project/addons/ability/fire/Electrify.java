...
public class Electrify extends LightningAbility implements AddonAbility {
    ...
    public Electrify(Player player, Block block, boolean direct, int spread) {
        ...
        if (!ProjectAddons.instance.getConfig(bPlayer).getStringList("Properties.MetallicBlocks").contains(block.getType().toString()) && block.getType() != Material.WATER) {
            return;
        ...
        this.cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.Electrify.Cooldown");
        this.duration = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.Electrify.Duration");
        this.waterdmg = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.Electrify.DamageInWater");
        this.slowness = ProjectAddons.instance.getConfig(bPlayer).getInt("Abilities.Fire.Electrify.Slowness") + 1;
        this.weakness = ProjectAddons.instance.getConfig(bPlayer).getInt("Abilities.Fire.Electrify.Weakness") + 1;
        this.spread = spread;
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Fire.Electrify.Enabled");
    }
