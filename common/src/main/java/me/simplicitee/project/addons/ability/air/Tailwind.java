...
public class Tailwind extends AirAbility implements ComboAbility, AddonAbility {
    ...
    public Tailwind(Player player) {
        ...
        cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Combos.Air.Tailwind.Cooldown");
        duration = ProjectAddons.instance.getConfig(bPlayer).getLong("Combos.Air.Tailwind.Duration");
        speed = ProjectAddons.instance.getConfig(bPlayer).getInt("Combos.Air.Tailwind.Speed") - 1;
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Combos.Air.Tailwind.Enabled");
    }
