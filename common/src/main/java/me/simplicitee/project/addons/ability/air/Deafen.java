...
public class Deafen extends SoundAbility implements AddonAbility {
    ...
    public Deafen(Player player) {
        ...
        this.duration = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Air.Deafen.Duration");
        this.cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Air.Deafen.Cooldown");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Air.Deafen.Enabled");
    }
}
