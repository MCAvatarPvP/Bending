...
public class CombustBeam extends CombustionAbility implements AddonAbility {
    ...
    public CombustBeam(Player player) {
        ...
        this.cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.CombustBeam.Cooldown");
        this.minChargeTime = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.CombustBeam.Minimum.ChargeTime");
        this.maxChargeTime = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.CombustBeam.Maximum.ChargeTime");
        this.minAngle = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.CombustBeam.Minimum.Angle");
        this.maxAngle = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.CombustBeam.Maximum.Angle");
        this.minPower = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.CombustBeam.Minimum.Power");
        this.maxPower = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.CombustBeam.Maximum.Power");
        this.minDamage = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.CombustBeam.Minimum.Damage");
        this.maxDamage = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.CombustBeam.Maximum.Damage");
        this.range = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.CombustBeam.Range");
        this.revertTime = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.CombustBeam.RevertTime");
        ...
        if (charging) {
            if (!bPlayer.getBoundAbilityName().equalsIgnoreCase("CombustBeam")) {
                ...
                if (player.getHealth() < health) {
                    DamageHandler.damageEntity(player, ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.CombustBeam.InterruptedDamage"), this);
                    explode();
                    return;
                }
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Fire.CombustBeam.Enabled");
    }
