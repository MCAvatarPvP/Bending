...
public class EnergyBeam extends AvatarAbility implements AddonAbility {
    ...
    public void setFields() {
        ...
        ranges = new HashMap<>();
        damage = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Avatar.EnergyBeam.Damage");
        range = ProjectAddons.instance.getConfig(bPlayer).getInt("Abilities.Avatar.EnergyBeam.Range");
        cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Avatar.EnergyBeam.Cooldown");
        duration = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Avatar.EnergyBeam.Duration");
        effects = ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Avatar.EnergyBeam.EasterEgg");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Avatar.EnergyBeam.Enabled");
    }
