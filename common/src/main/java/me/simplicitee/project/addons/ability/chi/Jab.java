...
public class Jab extends ChiAbility implements AddonAbility {
    ...
    public Jab(Player player, Entity entity, JabHand hand) {
        ...
        cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Chi.Jab.Cooldown");
        maxUses = ProjectAddons.instance.getConfig(bPlayer).getInt("Abilities.Chi.Jab.MaxUses");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Chi.Jab.Enabled");
    }
