...
public class Crumble extends SandAbility implements AddonAbility {
    ...
    public Crumble(Player player, ClickType click) {
        ...
        if (click == ClickType.LEFT_CLICK) {
            int selectRange = ProjectAddons.instance.getConfig(bPlayer).getInt("Abilities.Earth.Crumble.SelectRange");
        ...
        this.revertTime = ProjectAddons.instance.getConfig(bPlayer).getInt("Abilities.Earth.Crumble.RevertTime");
        this.counter = 0;
        this.radius = 0;
        this.cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Earth.Crumble.Cooldown");
        this.maxRadius = ProjectAddons.instance.getConfig(bPlayer).getInt("Abilities.Earth.Crumble.Radius");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Earth.Crumble.Enabled");
    }
