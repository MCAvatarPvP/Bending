...
public class GaleGust extends AirAbility implements AddonAbility {
    ...
    public GaleGust(Player player) {
        ...
        this.cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Air.GaleGust.Cooldown");
        this.knockback = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Air.GaleGust.Knockback");
        this.radius = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Air.GaleGust.Radius");
        this.damage = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Air.GaleGust.Damage");
        this.range = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Air.GaleGust.Range");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Air.GaleGust.Enabled");
    }
