...
public class MistShards extends IceAbility implements AddonAbility, ComboAbility {
    ...
    public MistShards(Player player) {
        ...
        this.cooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Combos.Water.MistShards.Cooldown");
        this.damage = ProjectAddons.instance.getConfig(bPlayer).getDouble("Combos.Water.MistShards.Damage");
        this.range = ProjectAddons.instance.getConfig(bPlayer).getDouble("Combos.Water.MistShards.Range");
        this.icicleCount = ProjectAddons.instance.getConfig(bPlayer).getInt("Combos.Water.MistShards.IcicleCount");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Combos.Water.MistShards.Enabled");
    }
