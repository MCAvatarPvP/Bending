...
public class Jets extends FireAbility implements AddonAbility {
    ...
    public Jets(Player player, TurboJet source) {
        ...
        if (source == null && GeneralMethods.isOnGround(player)) {
            return;
        }

        this.maxHeight = ProjectAddons.instance.getConfig(bPlayer).getInt("Abilities.Fire.Jets.MaxHeight");
        ...
        this.flySpeed = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.Jets.FlySpeed");
        this.hoverSpeed = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.Jets.HoverSpeed");
        this.duration = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.Jets.Duration");
        this.maxCooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.Jets.Cooldown.Maximum");
        this.minCooldown = ProjectAddons.instance.getConfig(bPlayer).getLong("Abilities.Fire.Jets.Cooldown.Minimum");
        this.dmgThreshold = player.getHealth() - ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.Jets.DamageThreshold");
        double speedThreshold = ProjectAddons.instance.getConfig(bPlayer).getDouble("Abilities.Fire.Jets.SpeedThreshold");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Abilities.Fire.Jets.Enabled");
    }
