...
public class Dodging extends ChiAbility implements AddonAbility, PassiveAbility {
    ...
    public Dodging(Player player) {
        ...
        chance = ProjectAddons.instance.getConfig(bPlayer).getDouble("Passives.Chi.Dodging.Chance") / 100;
    }
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Passives.Chi.Dodging.Enabled");
    }
