...
public class FlightPassive extends FlightAbility implements AddonAbility, PassiveAbility {
    ...
    public FlightPassive(Player player) {
        ...
        flySpeed = (float) ProjectAddons.instance.getConfig(bPlayer).getDouble("Passives.Air.Flying.FlySpeed");
        speed = startSpeed = (float) ProjectAddons.instance.getConfig(bPlayer).getDouble("Passives.Air.Flying.Glide.StartSpeed");
        maxSpeed = (float) ProjectAddons.instance.getConfig(bPlayer).getDouble("Passives.Air.Flying.Glide.MaxSpeed");
        acceleration = (float) ProjectAddons.instance.getConfig(bPlayer).getDouble("Passives.Air.Flying.Acceleration");
    ...
    public boolean isEnabled() {
        return ProjectAddons.instance.getConfig(bPlayer).getBoolean("Passives.Air.Flying.Enabled");
    }
