...
public class JedCoreConfig {
    ...
    public JedCoreConfig(JedCore plugin) {
        ...
        config = new Config(new File("JedCore/config.yml"));
        board = new Config(new File("JedCore/board.yml"));
        loadConfigBoard();
        loadConfigCore();
        addDeathMessages();
    }
    ...
    public static PKConfiguration getConfig(BendingPlayer bPlayer) {
        boolean perWorldConfig = config.getBooleanSuper("Properties.PerWorldConfig");
        if (bPlayer != null && !perWorldConfig) {
            return config.getConfig(bPlayer);
        }
        return getConfig((World) null);
    }

    public static PKConfiguration getConfig(Player player) {
        if (player == null)
            return getConfig((World) null);
        return getConfig(player.getWorld());
    }

    public static PKConfiguration getConfig(World world) {
        boolean perWorldConfig = config.getBooleanSuper("Properties.PerWorldConfig");
    ...
    private void loadConfigCore() {
        ...
        config.addDefault("Abilities.Air.AirBlade.Growth", 0.8);
        config.addDefault("Abilities.Air.AirBlade.GrowthRate", 0.125);
        ...
        config.addDefault("Abilities.Air.AirPunch.Description", "Left-Click to punch a high density packet of air "
                + "at enemies to do slight damage to them. The packet moves faster when you are moving faster.");
        ...
        config.addDefault("Abilities.Air.AirPunch.MinProjectileSpeed", 1.0);
        config.addDefault("Abilities.Air.AirPunch.MaxProjectileSpeed", 6.0);
        config.addDefault("Abilities.Air.AirPunch.MovementSpeedMultiplier", 10.0);
        config.addDefault("Abilities.Air.AirPunch.ApplyVelocity", true);
        config.addDefault("Abilities.Air.AirPunch.VelocityMultiplier", 0.25);
        ...
        config.addDefault("Abilities.Air.AirCombo.AirSlam.FailedAttemptCooldown", 2000);
        ...
        config.addDefault("Abilities.Earth.EarthLine.Knockback", 2.0);
        config.addDefault("Abilities.Earth.EarthLine.AirBlocksUnderLine", true);
        ...
        config.addDefault("Abilities.Earth.EarthShard.AnimationSpeed", 0.8);
        config.addDefault("Abilities.Earth.EarthShard.MaxDistance", 0);
        ...
        config.addDefault("Abilities.Earth.LavaDisc.ControlWithSneak", true);
        ...
        config.addDefault("Abilities.Earth.MudSurge.InstantSource", false);
        config.addDefault("Abilities.Earth.MudSurge.AllowFallDamage", false);
        config.addDefault("Abilities.Earth.MudSurge.MudBlocks", Arrays.asList("SAND", "RED_SAND", "CLAY", "TERRACOTTA", "BLACK_TERRACOTTA", "BLUE_TERRACOTTA",
                ...
                "MAGENTA_TERRACOTTA", "ORANGE_TERRACOTTA", "PINK_TERRACOTTA",
                "PURPLE_TERRACOTTA", "RED_TERRACOTTA", "WHITE_TERRACOTTA", "YELLOW_TERRACOTTA",
                "GRASS_BLOCK", "DIRT", "MYCELIUM", "COARSE_DIRT", "ROOTED_DIRT",
                "SOUL_SAND", "SOUL_SOIL", "RED_SANDSTONE", "SANDSTONE", "CHISELED_SANDSTONE",
                "CHISELED_RED_SANDSTONE", "SMOOTH_SANDSTONE", "SMOOTH_RED_SANDSTONE", "CUT_SANDSTONE",
                "CUT_RED_SANDSTONE", "MUD", "MUDDY_MANGROVE_ROOTS", "PACKED_MUD"));
        ...
        config.addDefault("Abilities.Earth.EarthCombo.Crevice.Controllable", false);
        config.addDefault("Abilities.Earth.EarthCombo.Crevice.VerticalRevert", true);
        config.addDefault("Abilities.Earth.EarthCombo.Crevice.RevertPerBlockDelay", 250);
        ...
        config.addDefault("Abilities.Earth.EarthCombo.MagmaBlast.Radius", 2.0);
        ...
        config.addDefault("Abilities.Fire.Discharge.Knockback", 0.8);
        ...
        config.addDefault("Abilities.Fire.FireBall.ForwardSpeed", 1);
        config.addDefault("Abilities.Fire.FireBall.SideSpeed", 0);
        ...
        config.addDefault("Abilities.Fire.FirePunch.ActivationOnPunch", true);
        config.addDefault("Abilities.Fire.FirePunch.AllowJetBlazeFusion", false);
        ...
        config.addDefault("Abilities.Fire.FireShots.ForwardSpeed", 1);
        config.addDefault("Abilities.Fire.FireShots.SideSpeed", 0);
        ...
        config.addDefault("Abilities.Fire.FireSki.FlyInDirection", false);
        ...
        config.addDefault("Abilities.Fire.LightningBurst.CanSwapSlots", true);
        config.addDefault("Abilities.Fire.LightningBurst.AllowWhenFireShield", false);
        ...
        config.addDefault("Abilities.Water.FrostBreath.FreezeTempBlocks", true);
        ...
        config.addDefault("Abilities.Water.IceWall.Radius", 2.5);
        config.addDefault("Abilities.Water.IceWall.AllowSnow", true);
        config.addDefault("Abilities.Water.IceWall.CanBreak", true);
        config.addDefault("Abilities.Water.IceWall.BreakHitbox", 1.0);
        ...
        config.addDefault("Abilities.Chi.DaggerThrow.RequiresArrows", false);
        ...
        config.addDefault("Abilities.Passives.WallRun.CancelWhenSneak", true);
    ...
    private void addDeathMessages() {
        PKConfiguration lang = ConfigManager.languageConfig.get();
