...
public class CollisionInitializer<T extends CoreAbility> {
    ...
    public boolean initialize() {
        ...
        PKConfigurationSection section = JedCore.plugin.getConfig().getConfigurationSection(collisionPath);
        for (String key : section.getKeys(false)) {
            PKConfigurationSection abilityConfig = section.getConfigurationSection(key);
