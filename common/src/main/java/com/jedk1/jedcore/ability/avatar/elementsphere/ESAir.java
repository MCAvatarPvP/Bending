...
public class ESAir extends AvatarAbility implements AddonAbility {
    ...
    public void setFields() {
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Avatar.ElementSphere.Air.Cooldown");
        range = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Avatar.ElementSphere.Air.Range");
        damage = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Avatar.ElementSphere.Air.Damage");
        knockback = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Avatar.ElementSphere.Air.Knockback");
        speed = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Avatar.ElementSphere.Air.Speed");
    }
    ...
    private void advanceAttack() {
        for (int i = 0; i < speed; i++) {
            ...
            AirAbility.playAirbendingParticles(bPlayer, location, 5);
