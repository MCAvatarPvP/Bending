...
public class MetalShred extends MetalAbility implements AddonAbility {
    ...
    public void setFields() {
        selectRange = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.MetalShred.SourceRange");
        extendTick = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.MetalShred.ExtendTick");
        damage = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Earth.MetalShred.Damage");
    }
    ...
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Earth.MetalShred.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Earth.MetalShred.Enabled");
    }
}
