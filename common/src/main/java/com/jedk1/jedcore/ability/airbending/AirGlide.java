...
public class AirGlide extends AirAbility implements AddonAbility {
    ...
    public void setFields() {
        speed = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Air.AirGlide.Speed");
        fallSpeed = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Air.AirGlide.FallSpeed");
        particles = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Air.AirGlide.Particles");
        airspout = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Air.AirGlide.AllowAirSpout");
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Air.AirGlide.Cooldown");
        duration = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Air.AirGlide.Duration");
        requireGround = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Air.AirGlide.RequireGround") && cooldown > 0;
    }
    ...
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Air.AirGlide.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Air.AirGlide.Enabled");
    }
}
