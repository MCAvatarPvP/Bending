...
public class Bloodbending extends BloodAbility implements AddonAbility {
    ...
    public void setFields() {
        nightOnly = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.Bloodbending.NightOnly");
        fullMoonOnly = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.Bloodbending.FullMoonOnly");
        undeadMobs = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.Bloodbending.UndeadMobs");
        bloodbendingThroughBlocks = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.Bloodbending.IgnoreWalls");
        requireBound = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.Bloodbending.RequireBound");
        distance = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.Bloodbending.Distance");
        holdTime = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.Bloodbending.HoldTime");
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.Bloodbending.Cooldown");
    }
    ...
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Water.Bloodbending.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.Bloodbending.Enabled");
    }
}
