...
public class EarthPillar extends EarthAbility implements AddonAbility {
    ...
    public void setFields() {
        height = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.EarthPillar.Height");
        range = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.EarthPillar.Range");
    }
    ...
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Earth.EarthPillar.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Earth.EarthPillar.Enabled");
    }
}