...
public class MagmaBlast extends LavaAbility implements AddonAbility, ComboAbility {
    ...
    public static boolean blast(TempFallingBlock tfb, boolean entityCollision) {
        ...
        AABB blockBounds = new AABB(tfb.getFallingBlock().getWorld(), tfb.getFallingBlock().getBoundingBox());
    ...
    public void setFields() {
        maxSources = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.EarthCombo.MagmaBlast.MaxShots");
        sourceRange = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.EarthCombo.MagmaBlast.SearchRange");
        damage = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Earth.EarthCombo.MagmaBlast.ImpactDamage");
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.EarthCombo.MagmaBlast.Cooldown");
        requireLavaFlow = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Earth.EarthCombo.MagmaBlast.RequireLavaFlow");
        playerCollisions = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Earth.EarthCombo.MagmaBlast.PlayerCollisions");
        entitySelection = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Earth.EarthCombo.MagmaBlast.EntitySelection");
        selectRange = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Earth.EarthCombo.MagmaBlast.SelectRange");
        radius = (float) JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Earth.EarthCombo.MagmaBlast.Radius");
        explosionRadius = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Earth.EarthCombo.MagmaBlast.ExplosionRadius");
        fireSpeed = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Earth.EarthCombo.MagmaBlast.FireSpeed");
        maxDuration = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Earth.EarthCombo.MagmaBlast.MaxDuration");
        maxDistanceFromSources = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Earth.EarthCombo.MagmaBlast.MaxDistanceFromSources");
        shotCooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Earth.EarthCombo.MagmaBlast.ShotCooldown");
    }
    ...
    public void progress() {
        ...
        if (!bPlayer.canBendIgnoreBinds(this) || !(bPlayer.getBoundAbilityName().equalsIgnoreCase("LavaFlow"))) {
            remove();
            return;
        }
    ...
    public ArrayList<AbilityInformation> getCombination() {
        return ComboUtil.generateCombinationFromList(this, JedCoreConfig.getConfig(bPlayer).getStringList("Abilities.Earth.EarthCombo.MagmaBlast.Combination"));
    }

    @Override
    public String getInstructions() {
        return JedCoreConfig.getConfig(bPlayer).getString("Abilities.Earth.EarthCombo.MagmaBlast.Instructions");
    }

    @Override
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Earth.EarthCombo.MagmaBlast.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Earth.EarthCombo.MagmaBlast.Enabled");
    }
}
