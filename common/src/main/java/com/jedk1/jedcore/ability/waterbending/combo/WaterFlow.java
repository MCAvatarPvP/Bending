...
public class WaterFlow extends WaterAbility implements AddonAbility, ComboAbility {
    ...
    public void setFields() {
        sourceRange = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.SourceRange");
        maxRange = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.MaxRange");
        minRange = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.MinRange");
        duration = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.WaterCombo.WaterFlow.Duration");
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.Cooldown");
        meltDelay = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.MeltDelay");
        trail = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.Trail");
        avatar = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterFlow.IsAvatarStateToggle");
        avatarDuration = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.WaterCombo.WaterFlow.AvatarStateDuration");
        stayAtSource = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterFlow.PlayerStayNearSource");
        stayRange = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.MaxDistanceFromSource");
        canUseBottle = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterFlow.BottleSource");
        canUsePlants = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterFlow.PlantSource");
        removeOnAnyDamage = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterFlow.RemoveOnAnyDamage");
        fullMoonCooldown = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.FullMoon.Modifier.Cooldown");
        fullMoonDuration = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.FullMoon.Modifier.Duration");
        fullMoonEnabled = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterFlow.FullMoon.Enabled");
        playerRideOwnFlow = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterFlow.PlayerRideOwnFlow");
        size = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.Size.Normal");
        avatarSize = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.Size.AvatarState");
        fullMoonSizeSmall = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.Size.FullmoonSmall");
        fullMoonSizeLarge = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterFlow.Size.FullmoonLarge");
    ...
    public ArrayList<AbilityInformation> getCombination() {
        return ComboUtil.generateCombinationFromList(this, JedCoreConfig.getConfig(bPlayer).getStringList("Abilities.Water.WaterCombo.WaterFlow.Combination"));
    }

    @Override
    public String getInstructions() {
        return JedCoreConfig.getConfig(bPlayer).getString("Abilities.Water.WaterCombo.WaterFlow.Instructions");
    }

    @Override
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Water.WaterCombo.WaterFlow.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterFlow.Enabled");
    }
}
