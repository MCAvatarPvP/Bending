...
public class BloodPuppet extends BloodAbility implements AddonAbility {
    ...
    public void setFields() {
        nightOnly = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.BloodPuppet.NightOnly");
        fullMoonOnly = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.BloodPuppet.FullMoonOnly");
        undeadMobs = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.BloodPuppet.UndeadMobs");
        bloodPuppetThroughBlocks = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.BloodPuppet.IgnoreWalls");
        requireBound = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.BloodPuppet.RequireBound");
        distance = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.BloodPuppet.Distance");
        holdTime = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.BloodPuppet.HoldTime");
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.BloodPuppet.Cooldown");
    }
    ...
    private void attack() {
        ...
        if (System.currentTimeMillis() > lastDamageTime + damageCd) {
            ...
            if (puppet instanceof Skeleton) {
                ...
                //	PotionEffect potion = new PotionEffect(PotionType.HARMING);
    ...
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Water.BloodPuppet.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.BloodPuppet.Enabled");
    }
}
