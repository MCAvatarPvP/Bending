...
public class WaterGimbal extends WaterAbility implements AddonAbility, ComboAbility, EntityHitboxProvider {
    ...
    public void setFields() {
        sourceRange = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterGimbal.SourceRange");
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.WaterCombo.WaterGimbal.Cooldown");
        ringSize = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Water.WaterCombo.WaterGimbal.RingSize");
        range = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Water.WaterCombo.WaterGimbal.Range");
        damage = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Water.WaterCombo.WaterGimbal.Damage");
        speed = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Water.WaterCombo.WaterGimbal.Speed");
        animSpeed = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.WaterGimbal.AnimationSpeed");
        plantSourcing = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterGimbal.PlantSource");
        snowSourcing = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterGimbal.SnowSource");
        requireAdjacentPlants = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterGimbal.RequireAdjacentPlants");
        canUseBottle = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterGimbal.BottleSource");
        abilityCollisionRadius = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Water.WaterCombo.WaterGimbal.AbilityCollisionRadius");
        entityCollisionRadius = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Water.WaterCombo.WaterGimbal.EntityCollisionRadius");
    ...
    public ArrayList<AbilityInformation> getCombination() {
        return ComboUtil.generateCombinationFromList(this, JedCoreConfig.getConfig(bPlayer).getStringList("Abilities.Water.WaterCombo.WaterGimbal.Combination"));
    }

    @Override
    public String getInstructions() {
        return JedCoreConfig.getConfig(bPlayer).getString("Abilities.Water.WaterCombo.WaterGimbal.Instructions");
    }

    @Override
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Water.WaterCombo.WaterGimbal.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.WaterGimbal.Enabled");
    }
}
