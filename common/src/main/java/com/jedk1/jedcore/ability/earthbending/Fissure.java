...
public class Fissure extends LavaAbility implements AddonAbility {
    ...
    public void setFields() {
        slapRange = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.Fissure.SlapRange");
        maxWidth = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.Fissure.MaxWidth");
        slapDelay = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.Fissure.SlapDelay");
        duration = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.Fissure.Duration");
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.Fissure.Cooldown");
    }
    ...
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Earth.Fissure.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Earth.Fissure.Enabled");
    }
}