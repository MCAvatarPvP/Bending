...
public class ESStream extends AvatarAbility implements AddonAbility {
    ...
    public void setFields() {
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Avatar.ElementSphere.Stream.Cooldown");
        range = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Avatar.ElementSphere.Stream.Range");
        damage = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Avatar.ElementSphere.Stream.Damage");
        knockback = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Avatar.ElementSphere.Stream.Knockback");
        requiredUses = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Avatar.ElementSphere.Stream.RequiredUses");
        cancelAbility = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Avatar.ElementSphere.Stream.EndAbility");
        radius = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Avatar.ElementSphere.Stream.ImpactCraterSize");
        regen = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Avatar.ElementSphere.Stream.ImpactRevert");
    }
