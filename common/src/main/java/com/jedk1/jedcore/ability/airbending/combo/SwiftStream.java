...
public class SwiftStream extends FlightAbility implements AddonAbility, ComboAbility {
    ...
    public void setFields() {
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Air.AirCombo.SwiftStream.Cooldown");
        dragFactor = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Air.AirCombo.SwiftStream.DragFactor");
        duration = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Air.AirCombo.SwiftStream.Duration");
    }
    ...
    public ArrayList<AbilityInformation> getCombination() {
        return ComboUtil.generateCombinationFromList(this, JedCoreConfig.getConfig(bPlayer).getStringList("Abilities.Air.AirCombo.SwiftStream.Combination"));
    }

    @Override
    public String getInstructions() {
        return JedCoreConfig.getConfig(bPlayer).getString("Abilities.Air.AirCombo.SwiftStream.Instructions");
    }

    @Override
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Air.AirCombo.SwiftStream.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Air.AirCombo.SwiftStream.Enabled");
    }
}