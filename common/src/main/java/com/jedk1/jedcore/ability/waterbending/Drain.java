...
public class Drain extends WaterAbility implements AddonAbility {
    ...
    public void setFields() {
        regenDelay = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.Drain.RegenDelay");
        duration = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.Drain.Duration");
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.Drain.Cooldown");
        absorbSpeed = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Water.Drain.AbsorbSpeed");
        radius = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.Drain.Radius");
        chance = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.Drain.AbsorbChance");
        absorbRate = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.Drain.AbsorbRate");
        holdRange = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.Drain.HoldRange");
        blastsEnabled = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.Drain.BlastsEnabled");
        maxBlasts = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.Drain.MaxBlasts");
        keepSrc = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.Drain.KeepSource");
        blastRange = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Water.Drain.BlastRange");
        blastDamage = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Water.Drain.BlastDamage");
        blastSpeed = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Water.Drain.BlastSpeed");
        useRain = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.Drain.AllowRainSource");
        drainTemps = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.Drain.DrainTempBlocks");
