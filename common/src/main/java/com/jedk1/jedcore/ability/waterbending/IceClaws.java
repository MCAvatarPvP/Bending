...
public class IceClaws extends IceAbility implements AddonAbility {
    ...
    public void setFields() {
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.IceClaws.Cooldown");
        chargeUp = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.IceClaws.ChargeTime");
        slowDur = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.IceClaws.SlowDuration") / 50;
        damage = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Water.IceClaws.Damage");
        range = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Water.IceClaws.Range");
        throwable = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.IceClaws.Throwable");
    ...
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Water.IceClaws.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.IceClaws.Enabled");
    }
}