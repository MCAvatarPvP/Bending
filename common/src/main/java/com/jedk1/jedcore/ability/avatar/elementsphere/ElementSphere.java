...
public class ElementSphere extends AvatarAbility implements AddonAbility, MultiAbility {
    ...
    public void setFields() {
        airUses = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Avatar.ElementSphere.Air.Uses");
        fireUses = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Avatar.ElementSphere.Fire.Uses");
        waterUses = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Avatar.ElementSphere.Water.Uses");
        earthUses = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Avatar.ElementSphere.Earth.Uses");
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Avatar.ElementSphere.Cooldown");
        duration = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Avatar.ElementSphere.Duration");
        height = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Avatar.ElementSphere.MaxControlledHeight");
        speed = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Avatar.ElementSphere.FlySpeed");
    }
    ...
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Avatar.ElementSphere.Description");
    }
