...
public class MetalHook extends MetalAbility implements AddonAbility {
    ...
    public void setFields() {
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Earth.MetalHook.Cooldown");
        range = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.MetalHook.Range");
        maxHooks = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.MetalHook.MaxHooks");
        totalHooks = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.MetalHook.TotalHooks");
        noSource = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Earth.MetalHook.RequireItem");
        barrierHooking = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Earth.MetalHook.BarrierHooking");
    }
    ...
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Earth.MetalHook.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Earth.MetalHook.Enabled");
    }
}
