...
public class Maelstrom extends WaterAbility implements AddonAbility, ComboAbility {
    ...
    public void setFields() {
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.WaterCombo.Maelstrom.Cooldown");
        duration = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Water.WaterCombo.Maelstrom.Duration");
        depth = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.Maelstrom.MaxDepth");
        range = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Water.WaterCombo.Maelstrom.Range");
        canRemove = true;
...
//			}
    ...
    public ArrayList<AbilityInformation> getCombination() {
        return ComboUtil.generateCombinationFromList(this, JedCoreConfig.getConfig(bPlayer).getStringList("Abilities.Water.WaterCombo.Maelstrom.Combination"));
    }

    @Override
    public String getInstructions() {
        return JedCoreConfig.getConfig(bPlayer).getString("Abilities.Water.WaterCombo.Maelstrom.Instructions");
    }

    @Override
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Water.WaterCombo.Maelstrom.Description");
    }
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Water.WaterCombo.Maelstrom.Enabled");
    }
}
