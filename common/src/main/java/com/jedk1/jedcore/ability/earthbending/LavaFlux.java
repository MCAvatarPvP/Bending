...
public class LavaFlux extends LavaAbility implements AddonAbility {
    ...
    public void setFields() {
        speed = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.LavaFlux.Speed");
        if (speed < 1) speed = 1;
        range = JedCoreConfig.getConfig(this.bPlayer).getInt("Abilities.Earth.LavaFlux.Range");
        cooldown = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Earth.LavaFlux.Cooldown");
        duration = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Earth.LavaFlux.Duration");
        cleanup = JedCoreConfig.getConfig(this.bPlayer).getLong("Abilities.Earth.LavaFlux.Cleanup");
        damage = JedCoreConfig.getConfig(this.bPlayer).getDouble("Abilities.Earth.LavaFlux.Damage");
        wave = JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Earth.LavaFlux.Wave");
    }
    ...
    public String getDescription() {
        return "* JedCore Addon *\n" + JedCoreConfig.getConfig(this.bPlayer).getString("Abilities.Earth.LavaFlux.Description");
    }
    ...
    @Override
    public void load() {
        if (JedCoreConfig.getConfig(this.bPlayer).get("Abilities.Earth.LavaFlux.Speed") instanceof String) {
            JedCoreConfig.getConfig(this.bPlayer).set("Abilities.Earth.LavaFlux.Speed", 1);
    ...
    public boolean isEnabled() {
        return JedCoreConfig.getConfig(this.bPlayer).getBoolean("Abilities.Earth.LavaFlux.Enabled");
    }
}
