    ...
    public void progress() {
        if (!this.bPlayer.canBendIgnoreBindsCooldowns(this)) {
            ...
            if (isWater(topBlock) && !canPassThroughWater(topBlock)) {
                ...
                remove();
                return;
            } else if (GeneralMethods.isSolid(topBlock.getRelative(BlockFace.UP)) || (isWater(topBlock.getRelative(BlockFace.UP)) && !canPassThroughWater(topBlock.getRelative(BlockFace.UP)))) {
                remove();
                return;
            }
