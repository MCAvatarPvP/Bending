...
import com.projectkorra.projectkorra.platform.mc.configuration.file.YamlConfiguration;
...
public class Metrics {
    ...
    public Metrics(Plugin plugin, int serviceId) {
        ...
        metricsBase =
                new // See https://github.com/Bastian/bstats-metrics/pull/126
                        ...
                        isFolia
                                ? null
                                : submitDataTask -> Platform.scheduler().runNow(submitDataTask),
                        plugin::isEnabled,
    ...
    private void appendPlatformData(JsonObjectBuilder builder) {
        ...
        builder.appendField("onlineMode", Platform.server().onlineMode() ? 1 : 0);
        builder.appendField("bukkitVersion", Platform.server().version());
        builder.appendField("bukkitName", Platform.server().name());
