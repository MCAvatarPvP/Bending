...
public final class ReflectionHandler {
    ...
    public enum PackageType {
        ...
        public static String getServerVersion() {
            return Platform.server().handle().getClass().getPackage().getName().substring(23);
        }
