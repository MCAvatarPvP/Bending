...
public class DamageHandler {
    ...
    public static double getIgnoreArmorPercentage(@NotNull final Ability ability) {
        PKConfiguration config = ProjectKorra.plugin.getConfig();
    ...
    private static void damageEntityNow(final Entity entity, Player source, double damage, final Ability ability,
        ...
        final AbilityDamageEntityEvent damageEvent = new AbilityDamageEntityEvent(entity, source, ability, damage, (ignoreArmor || percentage == 1.));
