...
public class ConfigManager {
    ...
    public static Config waterCosmeticsConfig;
    ...
    public ConfigManager() {
        ...
        waterCosmeticsConfig = new Config(new File("waterCosmetics.yml"));
        ...
        File styleAvatarStateDir = Platform.dataFolder().resolve("Styles").toFile();
        if (!styleAvatarStateDir.exists() && !styleAvatarStateDir.mkdirs()) {
            Platform.logger().warning("Failed to create AvatarState styles directory: " + styleAvatarStateDir);
        }
        File avatarStateFile = new File(styleAvatarStateDir, "avatarstate.yml");

        // Keep AvatarState modifiers in their own style file.  Falling back to
        // config.yml is dangerous: ConfigManager registers boosted AvatarState
        ...
        configCheck(ConfigType.WATERCOSMETICS);
    ...
    public static void configCheck(final ConfigType type) {
        ...
        if (type == ConfigType.PRESETS) {
            ...
            config.addDefault("AddCollisions", List.of("FirstAbility, SecondAbility, RemoveFirst, RemoveSecond"));
            config.addDefault("Collisions", List.of("FirstAbility, SecondAbility"));
            config.addDefault("FallingBlockCollisions", List.of("FallingBlockAbility, VelocityAbility"));
            collisionConfig.save();
        } else if (type == ConfigType.FIRECOLORS) {
            config = fireColorsConfig.get();
            config.addDefault("FireColors", List.of(
                    "name, hexColor, size",
                    "greenfire, particle, COPPER_FIRE_FLAME"
            ));
            fireColorsConfig.save();
        } else if (type == ConfigType.AIRCOLORS) {
            config = airColorsConfig.get();
            config.addDefault("AirColors", List.of("name, hexColor"));
            ...
            config.addDefault("EarthCosmetics", List.of("name, material"));
            ...
            config.addDefault("Board.Extras.FireBlastCharged", Element.FIRE.getColor().getName());
            ...
            config.addDefault("Commands.ComboHelp.Description", "Shows live combo input feedback and the combo sequence in titles.");
            config.addDefault("Commands.ComboHelp.InvalidCombo", "{combo} is not a valid combo ability.");
            config.addDefault("Commands.ComboHelp.NoPermissionForCombo", "You do not have permission to use {combo}.");
            config.addDefault("Commands.ComboHelp.Started", "Combo help enabled for {combo}.");
            config.addDefault("Commands.ComboHelp.Stopped", "Combo help disabled.");
            ...
            config.addDefault("Commands.WaterCosmetic.ChangedCosmetic", "Successfully changed water cosmetic to {cosmetic}.");
            ...
            config.addDefault("Commands.DetailedActionBar.Description", "Toggle the detailed action bar display.");
            config.addDefault("Commands.DetailedActionBar.ToggledOn", "Detailed action bar enabled.");
            config.addDefault("Commands.DetailedActionBar.ToggledOff", "Detailed action bar disabled.");

            config.addDefault("Commands.OldScooter.Description", "Toggle legacy ProjectKorra AirScooter behavior.");
            config.addDefault("Commands.OldScooter.ToggledOn", "Legacy AirScooter behavior enabled.");
            config.addDefault("Commands.OldScooter.ToggledOff", "Modern AirScooter behavior enabled.");
            ...
            config.addDefault("Abilities.Air.Combo.SummonSelf.Instructions", "AirBlast (Tap Shift) > AirBlast (Tap Shift) > AirBurst (Left Click)");
            ...
            config.addDefault("Abilities.Air.Passive.Winded.Description", "Winded rewards active air duels with increased air stamina regeneration. If an airbender runs from another airbender without fighting back, they leave a wind stream the chaser can use to recover stamina.");
...
//			config.addDefault("Abilities.Water.PlantTether.DeathMessage", "{victim} was constricted by {attacker}'s {ability}");
            ...
            config.addDefault("Properties.BendingPreviewMaxLength", 120);
            config.addDefault("Properties.BendingPreviewMaxCooldowns", 3);
            config.addDefault("Properties.BendingPreviewShowStamina", true);
            ...
            config.addDefault("Properties.Water.IceMaterial", "ICE");
            ...
            config.addDefault("Properties.Fire.CanGoThroughTempWater", true);
            ...
            config.addDefault("Abilities.Air.Passive.Winded.Enabled", true);
            config.addDefault("Abilities.Air.Passive.Winded.DuelRadius", 9.0);
            config.addDefault("Abilities.Air.Passive.Winded.CloseCircleRadius", 3.0);
            config.addDefault("Abilities.Air.Passive.Winded.ChaseRadius", 14.0);
            config.addDefault("Abilities.Air.Passive.Winded.StreamWidth", 2.5);
            config.addDefault("Abilities.Air.Passive.Winded.StreamLength", 7.0);
            config.addDefault("Abilities.Air.Passive.Winded.MinHorizontalSpeed", 0.15);
            config.addDefault("Abilities.Air.Passive.Winded.FleeDot", 0.55);
            config.addDefault("Abilities.Air.Passive.Winded.DistanceIncrease", 0.08);
            config.addDefault("Abilities.Air.Passive.Winded.RecentAbilityTicks", 50);
            config.addDefault("Abilities.Air.Passive.Winded.DuelRegenRate", 0.18);
            config.addDefault("Abilities.Air.Passive.Winded.ChaseRegenRate", 0.35);
            config.addDefault("Abilities.Air.Passive.Winded.FleeingRegenRate", 0.05);
            config.addDefault("Abilities.Air.Passive.Winded.ParticleInterval", 3);
            ...
            config.addDefault("Abilities.Air.AirBlast.RequireSourceTouchingBlock", false);
            ...
            config.addDefault("Abilities.Air.AirBurst.Range", 16);
            config.addDefault("Abilities.Air.AirBurst.Speed", 1.2);
            config.addDefault("Abilities.Air.AirBurst.Radius", 1.25);
            config.addDefault("Abilities.Air.AirBurst.Particles", 3);
            ...
            config.addDefault("Abilities.Air.AirScooter.StaminaDrainRate", 0.1);
            ...
            config.addDefault("Abilities.Air.AirSurf.StaminaDrainRate", 0.1);
            ...
            config.addDefault("Abilities.Air.AirSurf.CancelOnHit", new ArrayList<>());
            ...
            config.addDefault("Abilities.Air.AirSpout.StaminaDrainRate", 0.05);
            ...
            config.addDefault("Abilities.Air.AirSpout.Animation.Tendrils", 3);
            config.addDefault("Abilities.Air.AirSpout.Animation.ConstraintIterations", 3);
            config.addDefault("Abilities.Air.AirSpout.Animation.SegmentSpacing", 0.45);
            ...
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.FullLiftAirspeed", 0.70);
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.MaximumCoastLift", 0.035);
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.PoweredLift", 0.012);
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.CoastTurnDegrees", 9.0);
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.PoweredTurnDegrees", 13.0);
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.TurnDragPerDegree", 0.0012);
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.StallLiftFactor", 0.12);
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.HorizontalAcceleration", 0.022);
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.DiveAcceleration", 0.065);
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.DescentConversion", 0.55);
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.PoweredStaminaDrain", 0.0);
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.PoweredTurnStaminaDrain", 0.0);
            addUpgradeDefault(defaultConfig, "Abilities.Air.AirGlider.Glide.MaximumVelocity", 1.55);
            ...
            config.addDefault("Abilities.Air.AirSuction.Push.OtherAirPush", 1.3);
            ...
            config.addDefault("Abilities.Air.AirSuction.RequireSourceTouchingBlock", false);
            ...
            config.addDefault("Abilities.Air.AirSwipe.PlayerVelocity.ForwardFactor", 1.0);
            config.addDefault("Abilities.Air.AirSwipe.PlayerVelocity.BackwardFactor", 1.0);
            config.addDefault("Abilities.Air.AirSwipe.PlayerVelocity.MinimumSpeed", 1.0);
            ...
            config.addDefault("Abilities.Air.Suffocate.Duration", 4000);
            config.addDefault("Abilities.Air.Suffocate.ProjectileSpeed", 1.2);
            ...
            config.addDefault("Abilities.Air.AirStream.MaxDuration", 10000);
            ...
            config.addDefault("Abilities.Air.SummonSelf.Enabled", true);
            config.addDefault("Abilities.Air.SummonSelf.Cooldown", 8000);
            config.addDefault("Abilities.Air.SummonSelf.MinimumSpeed", 0.45);
            config.addDefault("Abilities.Air.SummonSelf.MaximumSpeed", 1.6);
            config.addDefault("Abilities.Air.SummonSelf.MovementSpeedFactor", 2.0);
            config.addDefault("Abilities.Air.SummonSelf.Range", 30.0);
            config.addDefault("Abilities.Air.SummonSelf.CollisionRadius", 1.1);
            config.addDefault("Abilities.Air.SummonSelf.Gravity", 0.03);
            config.addDefault("Abilities.Air.SummonSelf.CasterKnockback.Minimum", 0.45);
            config.addDefault("Abilities.Air.SummonSelf.CasterKnockback.SpeedFactor", 0.8);
            config.addDefault("Abilities.Air.SummonSelf.OpponentKnockback.Minimum", 0.8);
            config.addDefault("Abilities.Air.SummonSelf.OpponentKnockback.SpeedFactor", 1.5);
            config.addDefault("Abilities.Air.SummonSelf.Impact.RingRadius", 1.4);
            config.addDefault("Abilities.Air.SummonSelf.Impact.RingStep", 12.0);
            config.addDefault("Abilities.Air.SummonSelf.Combination", Arrays.asList("AirBlast:SNEAK_DOWN", "AirBlast:SNEAK_UP", "AirBlast:SNEAK_DOWN", "AirBlast:SNEAK_UP", "AirBurst:LEFT_CLICK"));
            ...
            bloodless.add("SKELETON");
            bloodless.add("IRON_GOLEM");
            bloodless.add("BLAZE");
            bloodless.add("MAGMA_CUBE");
            bloodless.add("SHULKER");
            bloodless.add("SKELETON_HORSE");
            bloodless.add("WITHER_SKELETON");
            bloodless.add("STRAY");
            ...
            config.addDefault("Abilities.Water.Torrent.IsIceBendable", true);
...
//			config.addDefault("Abilities.Water.PlantTether.SelectRange", 10);
            ...
            config.addDefault("Abilities.Earth.Catapult.LaunchGroundTolerance", 1.0);
            ...
            earthTunnelIgnored.add("COAL_ORE"); // no longer needed in 1.17
            earthTunnelIgnored.add("IRON_ORE"); // no longer needed in 1.17
            earthTunnelIgnored.add("REDSTONE_ORE"); // no longer needed in 1.17
            earthTunnelIgnored.add("LAPIS_ORE"); // no longer needed in 1.17
            earthTunnelIgnored.add("DIAMOND_ORE"); // no longer needed in 1.17
            earthTunnelIgnored.add("EMERALD_ORE"); // no longer needed in 1.17
            ...
            earthTunnelIgnored.add("ANCIENT_DEBRIS");
            earthTunnelIgnored.add("GILDED_BLACKSTONE");
            earthTunnelIgnored.add("NETHER_QUARTZ_ORE");
            ...
            config.addDefault("Abilities.Fire.FireBlast.Charged.ChargeInWater", true);
            config.addDefault("Abilities.Fire.FireBlast.Charged.DamagedBlocksRevertTime", 3000);
            ...
            config.addDefault("Abilities.Fire.FireBlast.Charged.UseFireBlastCD", false);
            ...
            config.addDefault("Abilities.Fire.FireBurst.CanSwapSlots", true);
            ...
            config.addDefault("Abilities.Fire.HeatControl.Extinguish.Range", 7);
            ...
            config.addDefault("Abilities.Fire.Lightning.SilentHitbox.Mode", "DELAYED_INSTANT_ARC");
            config.addDefault("Abilities.Fire.Lightning.SilentHitbox.ProjectileSpeed", -1.0);
            config.addDefault("Abilities.Fire.Lightning.SilentHitbox.Step", 0.20);
            config.addDefault("Abilities.Fire.Lightning.SilentHitbox.Radius", 1.15);
            config.addDefault("Abilities.Fire.Lightning.SilentHitbox.SelfGrace", 1.50);
            ...
            config.addDefault("Abilities.Fire.FireSpin.Height", 2.0);
            config.addDefault("Abilities.Fire.FireSpin.Radius", 2);
            config.addDefault("Abilities.Fire.FireSpin.CollisionRadius", 0.3);
            ...
            config.addDefault("Abilities.Fire.FireWheel.HitboxWidth", 1.5);
            config.addDefault("Abilities.Fire.FireWheel.HitboxHeight", 1.5);
            config.addDefault("Abilities.Fire.FireWheel.HeightRadius", 1);
            config.addDefault("Abilities.Fire.FireWheel.CircleRadius", 1);
            ...
            config.addDefault("Abilities.Chi.Paralyze.AllowFlyingKickFusion", true);
    ...
    /**
     * v4 could accidentally use config.yml as the AvatarState style file when
     * the Styles directory did not exist yet.  That polluted config.yml with
     * top-level AvatarState/LowHealth/PotionEffects sections.  Move those
     * sections back to Styles/avatarstate.yml before any ConfigManager save
     * writes the cleaned default config.
     */
    private static void repairMisplacedAvatarStateConfig() {
        if (defaultConfig == null || avatarStateConfig == null || defaultConfig == avatarStateConfig) return;
        boolean repaired = false;
        repaired |= moveTopLevelSection(defaultConfig, avatarStateConfig, "AvatarState");
        repaired |= moveTopLevelSection(defaultConfig, avatarStateConfig, "LowHealth");
        repaired |= moveTopLevelSection(defaultConfig, avatarStateConfig, "PotionEffects");
        if (repaired) {
            Platform.logger().warning("Moved misplaced AvatarState style sections out of config.yml and into Styles/avatarstate.yml. If ability values such as AirSwipe.Range were already overwritten in config.yml, restore those specific ability values from your backup once; this build prevents the pollution from happening again.");
        }
    }

    private static boolean moveTopLevelSection(final Config from, final Config to, final String sectionName) {
        final PKConfigurationSection section = from.getConfigurationSection(sectionName);
        if (section == null) return false;
        for (final String key : section.getKeys(true)) {
            final Object value = section.get(key);
            if (value instanceof PKConfigurationSection) continue;
            final String target = sectionName + "." + key;
    ...
    public static PKConfiguration getConfig(BendingPlayer bPlayer) {
    ...
    private static boolean hasChatPlugin() {
        ...
        return Platform.server().plugins().stream().anyMatch(pl -> plugins.contains(Platform.plugins().pluginName(pl)));
    }

    private static void migrateAvatarState() {
        PKConfiguration config = ConfigManager.defaultConfig.get();
        Config avatarState = ConfigManager.avatarStateConfig.get();

        PKConfigurationSection legacy = config.getConfigurationSection("Abilities.Avatar.AvatarState");
        ...
        Set<String> rootAvatarKeys = Set.of(
                "Enabled", "Cooldown", "Duration", "PlaySound", "ShowParticles",
                "GlowEnabled", "CanBeChiblocked", "CanBeChibblocked"
        );
        ...
        for (String key : legacy.getKeys(true)) {
            ...
            String target = null;
            if (key.startsWith("PotionEffects.")) {
                // Old config stored potion effects as nested Enabled/Power pairs.
                // The AvatarState style stores only the numeric power.
                if (key.endsWith(".Power")) {
                    String effect = key.substring("PotionEffects.".length(), key.length() - ".Power".length());
                    if (effect.equalsIgnoreCase("DamageResistance")) effect = "Resistance";
                    if (effect.equalsIgnoreCase("FireResistance")) effect = "Fire_Resistance";
                    target = "PotionEffects." + effect;
                }
            } else if (key.startsWith("Sound.")) {
                target = "AvatarState." + key;
            } else if (rootAvatarKeys.contains(key)) {
                target = "AvatarState." + key;
            } else if (!key.equals("PowerMultiplier") && !key.equals("Description")) {
                String newkey = key;
                for (String translation : translations.keySet()) {
                    if (key.endsWith(translation)) {
                        newkey = key.substring(0, key.length() - translation.length()) + translations.get(translation);
                        break;
                    }
                }
                target = "Abilities." + newkey;
            }

            if (target != null && !avatarState.contains(target)) {
                avatarState.set(target, value);
            }
        }

        ConfigManager.defaultConfig.removeTree("Abilities.Avatar.AvatarState");
