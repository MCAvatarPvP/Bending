...
public class WaterArmsFreeze extends IceAbility {
    ...
    private void createInstance() {
        ...
        if (this.waterArms != null) {
            ...
            this.direction = GeneralMethods.getDirection(this.location, GeneralMethods.getTargetedLocation(this.player, this.iceRange, Material.WATER, getIceMaterial(), Material.PACKED_ICE)).normalize();
        } else {
            return;
        }
        this.start();
