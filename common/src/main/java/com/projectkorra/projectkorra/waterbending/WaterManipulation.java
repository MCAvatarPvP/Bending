    ...
    public void progress() {
        ...
        if (System.currentTimeMillis() - this.time >= this.interval) {
            ...
            if (this.falling) {
                ...
                if (!this.progressing) {
                    if (!(isWater(this.sourceBlock.getType()) || isCauldron(this.sourceBlock) || isMud(this.sourceBlock) || isSponge(this.sourceBlock) || this.isIcebendable(this.sourceBlock) || (isSnow(this.sourceBlock) && this.bPlayer.canIcebend()) || (isPlant(this.sourceBlock) && this.bPlayer.canPlantbend()))) {
                        this.remove();
                        return;
                    }
                ...
                } else if (!isAir(block.getType()) && !isWater(block)) {
                    this.remove();
                    new WaterReturn(this.player, this.sourceBlock);
                    return;
                }
