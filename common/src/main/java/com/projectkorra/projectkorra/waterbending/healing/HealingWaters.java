...
public class HealingWaters extends HealingAbility {
    ...
    private void giveHP(final Player player) {
        if (!player.isDead() && player.getHealth() < player.getAttribute(com.projectkorra.projectkorra.platform.mc.attribute.Attribute.MAX_HEALTH).getValue()) {
    ...
    private void giveHP(final LivingEntity livingEntity) {
        if (!livingEntity.isDead() && livingEntity.getHealth() < livingEntity.getAttribute(com.projectkorra.projectkorra.platform.mc.attribute.Attribute.MAX_HEALTH).getValue()) {
    ...
    private void applyHealing(final LivingEntity livingEntity) {
        if (livingEntity.getHealth() < livingEntity.getAttribute(com.projectkorra.projectkorra.platform.mc.attribute.Attribute.MAX_HEALTH).getValue()) {
