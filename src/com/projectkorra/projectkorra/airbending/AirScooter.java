...
public class AirScooter extends AirAbility {
	...
	public AirScooter(final Player player) {
		...
		this.disableSpeed = getConfig().getBoolean("Abilities.Air.AirScooter.DisableSpeed");
		...
		this.midHeight = getConfig().getDouble("Abilities.Air.AirScooter.Height.Middle");
	...
	public void progress() {
		...
		double dx = Math.abs(distance - midHeight);
