    ...
    public void onAbilityStart(AbilityDamageEntityEvent event) {
        ...
        if (event.getEntity() instanceof Player target) {
            ...
            if (targetBPlayer != null) {
                ...
                List<String> scooterCancelList = ConfigManager.getConfig(targetBPlayer).getStringList("Abilities.Air.AirScooter.CancelOnHit");
                ...
                List<String> surfCancelList = ConfigManager.getConfig(targetBPlayer).getStringList("Abilities.Air.AirSurf.CancelOnHit");
                for (String cancelAbility : surfCancelList) {
                    if (cancelAbility.equalsIgnoreCase(abilityName)) {
                        AirSurf surf = CoreAbility.getAbility(target, AirSurf.class);
                        if (surf != null) {
                            surf.remove();
                        }
                        break;
